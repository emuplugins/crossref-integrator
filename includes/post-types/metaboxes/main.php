...
add_action('carbon_fields_register_fields', function () {
    ...
    // ------------------- Contribuintes -------------------
    Container::make('post_meta', 'Contribuintes (EX: Autores, Revisores)')
        ->where('post_type', 'IN', ['books', 'chapters'])
        ->add_fields([
            Field::make('complex', 'contributors', 'Contribuintes')
    ...
    Container::make('post_meta', 'XML Gerado')
        ->where('post_type', 'IN', ['books', 'chapters'])
        ->add_fields([
            Field::make('html', 'crossref_xml_display', 'XML Gerado')
                ->set_html(function () {
